...
% Regras
opcoes_categorias :-
    write('Escolha uma das categorias disponiveis:'), nl,
...
chat :-
    write('Ola, bem vindo ao chatbot do DETRAN-SP, como posso ajudar?'), nl,
    opcoes_categorias,
    read(Categoria),
    ...
    ;   write('Desculpe, nao tenho informacoes sobre isso.'), nl,
        fail
    ).
